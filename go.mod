...
replace (
	...
	github.com/openshift/library-go => github.com/openshift/library-go v0.0.0-20240124134907-4dfbf6bc7b11
	...
	k8s.io/dynamic-resource-allocation => dynamic-resource-allocation v0.29.1
